...
public class GEResizer extends GETransformer {
	...
	private Point getResizeAnchor(){
		...
		if(shape.getSelectedAnchor() == EAnchorTypes.NW){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.SE.ordinal());
		}else if(shape.getSelectedAnchor() == EAnchorTypes.NN){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.SS.ordinal());
		}else if(shape.getSelectedAnchor() == EAnchorTypes.NE){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.SW.ordinal());
		}else if(shape.getSelectedAnchor() == EAnchorTypes.WW){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.EE.ordinal());
		}else if(shape.getSelectedAnchor() == EAnchorTypes.EE){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.WW.ordinal());
		}else if(shape.getSelectedAnchor() == EAnchorTypes.SW){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.NE.ordinal());
		}else if(shape.getSelectedAnchor() == EAnchorTypes.SS){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.NN.ordinal());
		}else if(shape.getSelectedAnchor() == EAnchorTypes.SE){
			tempAnchor 
				= shape.getAnchorList().getAnchors().get(EAnchorTypes.NW.ordinal());
		}
